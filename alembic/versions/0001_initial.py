...
def upgrade():
    ...
    op.create_table("order_aims",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("code", sa.String(100), nullable=False, unique=True),
        sa.Column("name", sa.String(255), nullable=False),
    )
    op.create_table("order_sub_aims",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
    ...
    op.create_table("attribute_possible_values",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
    ...
    op.create_table("service_aim_mappings",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
    ...
    op.create_table("attribute_involvement",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("service_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("services.id", ondelete="CASCADE"), nullable=False),
        sa.Column("attribute_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("attributes.id", ondelete="RESTRICT"), nullable=False),
        sa.UniqueConstraint("service_id","attribute_id", name="uq_attribute_involvement")
    )
    op.create_table("attribute_involvement_allowed_values",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
    ...
    op.create_table("attribute_involvement_default_values",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("attribute_involvement_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("attribute_involvement.id", ondelete="CASCADE"), nullable=False),
        sa.Column("value_text", sa.String(255), nullable=False),
        sa.Column("sort_order", sa.Integer(), nullable=False, server_default="0")
    ...
    op.create_table("service_relations",
        ...
        sa.Column("relation_type", sa.String(50), nullable=False, server_default="decomposesTo"),
        sa.Column("instantiation_mode", sa.String(20), nullable=False)
    )
    op.create_table("attribute_propagation",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("relation_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("service_relations.id", ondelete="CASCADE"), nullable=False),
        sa.Column("parent_attribute_involvement_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("attribute_involvement.id", ondelete="CASCADE"), nullable=False),
        sa.Column("child_attribute_involvement_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("attribute_involvement.id", ondelete="CASCADE"), nullable=False),
        sa.Column("allowed_value_text", sa.String(255), nullable=True),
        sa.Column("sort_order", sa.Integer(), nullable=False, server_default="0")
    )
    op.create_table("diagram_layout",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("node_key", sa.String(255), nullable=False, unique=True),
...
def downgrade():
    ...
    op.drop_table("attribute_propagation")
    op.drop_table("service_relations")
    op.drop_table("attribute_involvement_default_values")
    op.drop_table("attribute_involvement_allowed_values")
